...
const Nav: React.FC = () => {
  ...
  return (
    <AppBar position="static" sx={{ backgroundColor: "#FDBD29" }} className="navbar">
      <Toolbar sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <IconButton edge="start" sx={{ color: "#0E100F" }} aria-label="menu" onClick={handleMenu}>
          <MenuIcon />
        </IconButton>

        <Box sx={{ flexGrow: 20, display: "flex", justifyContent: "center" }}>
          <img src="https://res.cloudinary.com/dchzjr4bz/image/upload/v1705710101/ww-high-resolution-logo-transparent_z3eelh.png" alt="Logo" style={{ maxHeight: 30 }} onClick={handleHomeClick}/>
        </Box>
